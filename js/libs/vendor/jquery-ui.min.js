 ...
 * http://jqueryui.com
 * Includes: core.js, widget.js, mouse.js, position.js, draggable.js, droppable.js, effect.js
...
(function (t) {
	...
	t.widget.extend = function (e) {
		for (var i, s, a = n.call(arguments, 1), o = 0, r = a.length; r > o; o++)
			for (i in a[o])
				s = a[o][i], a[o].hasOwnProperty(i) && void 0 !== s && (e[i] = t.isPlainObject(s) ? t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s) : s);
		return e
	},
	...
	function () {
		...
		t.fn.position = function (n) {
			...
			this.each(function () {
				...
				M = t.extend({}, _),
				N = e(D.my, u.outerWidth(), u.outerHeight());
